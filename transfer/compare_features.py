...
from distance import GramDistanceResnet50, CosineSimResnet50
...
OUTPUT_DIR = os.path.join(ROOT_DIR, 'emb-comparisons')
...
if __name__ == '__main__':
    ...
    cosine_sim_resnet = CosineSimResnet50()
    cosine_sim_resnet = cosine_sim_resnet.to(DEVICE)

    print('Comparing ImageNet vs Dog Breeds feature visualizations')
    run_cosine_sim(cosine_sim_resnet, IMAGENET_DIR, DOG_DIR, os.path.join(OUTPUT_DIR, 'dogs'))
    print()

    print('Comparing ImageNet vs Car Models feature visualizations')
    run_cosine_sim(cosine_sim_resnet, IMAGENET_DIR, CAR_DIR, os.path.join(OUTPUT_DIR, 'cars'))
